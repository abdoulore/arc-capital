...
const baseContracts = [
  {
    ...
    events: [
      ...
      "OracleUpdated(uint256,uint256)",
      "PenaltyApplied(address,uint256,uint256)",
      "NAVUpdated(uint256,uint256)",
    ],
  },
  {
    ...
    events: [
      ...
      "FixedIncomeConfigUpdated(address,string,uint256)",
      ...
      "TrancheConfigured(uint256,uint256,bool)",
    ],
  },
  {
    name: "DealFactoryV2",
  ...
  {
    name: "DealFactory",
    description: "ArcCapitalDealFactory",
    address: process.env.NEXT_PUBLIC_DEAL_FACTORY_ADDRESS,
    events: ["DealCreated(uint256,address,string,uint256,uint256)"],
  },
  {
    name: "MarketplaceV2",
  ...
  {
    name: "VaultFactory",
    description: "ArcCapitalVaultFactory",
    address: process.env.NEXT_PUBLIC_VAULT_FACTORY_ADDRESS,
    events: ["MonthlyVaultCreated(address,address)", "LongTermVaultCreated(address)"],
  },
  {
    name: "YieldRouter",
    description: "ArcCapitalYieldRouter",
    address: process.env.NEXT_PUBLIC_YIELD_ROUTER_ADDRESS,
    events: ["YieldRouted(address,address,uint256,string)", "TreasuryUpdated(address)"],
  },
  {
    name: "NAVOracle",
    description: "ArcCapitalNAVOracle",
    address: process.env.NEXT_PUBLIC_NAV_ORACLE_ADDRESS,
    events: ["NAVUpdated(address,uint256,uint256)"],
  },
